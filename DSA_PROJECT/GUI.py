...
def drawData(data,colorArray):
    ...
    for i, height in enumerate(normalised_data):
        ...
        y0 = canvas_height - height * 400       #to avoid data exceeding our canvas
...
algo_menu.current(0)         #this is by default for bubble sort
...
start = Button(root, text = "Start", bg="#C45B09", font = ("arial",12,"italic bold"), relief = SUNKEN, activebackground="#05945B", activeforeground="white", bd = 5, width= 10, command=Start_Algorithm)
